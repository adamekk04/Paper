...
public class LegacyTest {
    ...
    private final Set<Material> INVALIDATED_MATERIALS = new HashSet<>(Arrays.asList(Material.ACACIA_BUTTON, Material.ACACIA_PRESSURE_PLATE, Material.ACACIA_TRAPDOOR, Material.AIR, Material.ATTACHED_MELON_STEM, Material.ATTACHED_PUMPKIN_STEM,
            ...
            // 26.3
            Material.ABANDONED_CAMP_MAP, Material.BLACK_CUSHION, Material.BLUE_CUSHION, Material.BROWN_CUSHION, Material.CYAN_CUSHION, Material.GRAY_CUSHION, Material.GREEN_CUSHION, Material.LIGHT_BLUE_CUSHION, Material.LIGHT_GRAY_CUSHION, Material.LIME_CUSHION, Material.MAGENTA_CUSHION,
            Material.ORANGE_CUSHION, Material.PINK_CUSHION, Material.PURPLE_CUSHION, Material.RED_CUSHION, Material.WHITE_CUSHION, Material.YELLOW_CUSHION, Material.BURIED_ANCIENT_CITY_MAP, Material.BURIED_MINESHAFT_MAP, Material.BURIED_TREASURE_MAP, Material.BURIED_TRIAL_CHAMBERS_MAP,
            Material.DESERT_PYRAMID_MAP, Material.DESERT_VILLAGE_MAP, Material.JUNGLE_PYRAMID_MAP, Material.OCEAN_MONUMENT_MAP, Material.PLAINS_VILLAGE_MAP, Material.POPLAR_BOAT, Material.POPLAR_CHEST_BOAT, Material.SAVANNA_VILLAGE_MAP, Material.SNOWY_VILLAGE_MAP, Material.SWAMP_HUT_MAP,
            Material.TAIGA_VILLAGE_MAP, Material.WARM_OCEAN_RUINS_MAP, Material.WOODLAND_MANSION_MAP, Material.BLACK_CONCRETE_SLAB, Material.BLACK_CONCRETE_STAIRS, Material.BLUE_CONCRETE_SLAB, Material.BLUE_CONCRETE_STAIRS, Material.BROWN_CONCRETE_SLAB, Material.BROWN_CONCRETE_STAIRS,
            Material.CYAN_CONCRETE_SLAB, Material.CYAN_CONCRETE_STAIRS, Material.GRAY_CONCRETE_SLAB, Material.GRAY_CONCRETE_STAIRS, Material.GREEN_CONCRETE_SLAB, Material.GREEN_CONCRETE_STAIRS, Material.LIGHT_BLUE_CONCRETE_SLAB, Material.LIGHT_BLUE_CONCRETE_STAIRS,
            Material.LIGHT_GRAY_CONCRETE_SLAB, Material.LIGHT_GRAY_CONCRETE_STAIRS, Material.LIME_CONCRETE_SLAB, Material.LIME_CONCRETE_STAIRS, Material.MAGENTA_CONCRETE_SLAB, Material.MAGENTA_CONCRETE_STAIRS, Material.ORANGE_CONCRETE_SLAB, Material.ORANGE_CONCRETE_STAIRS,
            Material.PINK_CONCRETE_SLAB, Material.PINK_CONCRETE_STAIRS, Material.PURPLE_CONCRETE_SLAB, Material.PURPLE_CONCRETE_STAIRS, Material.RED_CONCRETE_SLAB, Material.RED_CONCRETE_STAIRS, Material.WHITE_CONCRETE_SLAB, Material.WHITE_CONCRETE_STAIRS, Material.YELLOW_CONCRETE_SLAB,
            Material.YELLOW_CONCRETE_STAIRS, Material.POPLAR_BUTTON, Material.POPLAR_DOOR, Material.POPLAR_FENCE, Material.POPLAR_FENCE_GATE, Material.POPLAR_HANGING_SIGN, Material.POPLAR_LOG, Material.POPLAR_PLANKS, Material.POPLAR_PRESSURE_PLATE,
            Material.POPLAR_SAPLING, Material.POPLAR_SHELF, Material.POPLAR_SIGN, Material.POPLAR_SLAB, Material.POPLAR_STAIRS, Material.POPLAR_TRAPDOOR, Material.POPLAR_WALL_HANGING_SIGN, Material.POPLAR_WALL_SIGN, Material.POPLAR_WOOD,
            Material.ORANGE_POPLAR_LEAVES, Material.POTTED_POPLAR_SAPLING, Material.RED_POPLAR_LEAVES, Material.STRIPPED_POPLAR_LOG, Material.STRIPPED_POPLAR_WOOD, Material.YELLOW_POPLAR_LEAVES,
            //
